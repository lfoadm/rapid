...
<div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
        <p class="mt-1 text-sm leading-6 text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla, dicta adipisci labore totam deserunt ducimus odio ipsam, doloribus magni libero perferendis ipsa? Ullam laudantium blanditiis et perferendis? Hic, dolore aliquam?</p>
        ...
        <div class="mt-10 grid grid-cols-1    gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-12">
                <label for="name"
                    class="block text-sm font-medium leading-6 text-gray-400">Lista de vereadores</label>
                <div class="mt-2">
