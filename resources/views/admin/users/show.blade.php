                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <form action="{{ route('users.destroy', $user) }}" method="POST">
                                    ...
                                    onclick="return confirm('Você tem certeza que deseja excluir esta ação?');">
                            ...
                            <div>
                                @if ($user->picture)
                                <img src="{{ asset($user->picture) }}" alt="" class="w-16 h-16 sm:w-80 sm:h-80 rounded-full object-cover mr-2">
                                @else
                                <img src="{{ asset('pictures/default.png') }}" alt="" class="w-16 h-16 sm:w-80 sm:h-80 rounded-full object-cover mr-2">
                                @endif
                            </div>
                        </div>
                    </div>
